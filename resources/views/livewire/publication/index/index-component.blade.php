<div class="p-6 sm:px-20 bg-white border-b border-gray-200 grid grid-cols-1 lg:grid-cols-3">
    <div class="lg:pr-16">
        <div class="border p-4 mt-4 mb-6 bg-gray-100">
    ...
    <div class="col-span-2">
        <div class="my-2">
            <x-jet-label for="search" value="{{ __('Search by title') }}" />
            <x-jet-input id="title" class="block mt-1 w-full" type="text" wire:model="q" />
        </div>
